...
const Sidebar = ({ onClose }) => {
  return (
    <div className="sidebar h-full  lg:h-[calc(100vh-4rem)] w-72 bg-white shadow-sm border-r">
      <div className="h-full flex flex-col">
        <div className="p-4 border-b flex items-center justify-between lg:border-none">
